...
const themes = {
  ...
  west: { gradient: 'from-violet-300 via-fuchsia-200 to-rose-200', bgStart: 'from-slate-800 via-slate-700/95', bgEnd: 'to-violet-900/35', textPrimary: 'text-violet-300', textSecondary: 'text-fuchsia-100', bgPrimarySubtle: 'bg-violet-400/12', borderPrimarySubtle: 'border-violet-200/20', borderPrimaryStrong: 'border-violet-300/30', shadowPrimary: 'shadow-[0_0_18px_rgba(167,139,250,0.22)]', orbPrimary: 'bg-violet-300/18', orbSecondary: 'bg-fuchsia-200/14' },
